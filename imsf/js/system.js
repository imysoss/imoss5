...
var feifei = {
		...
		'flickity':function(){//手机滑动
			if($(".ff-gallery").length){
				...
				$("<link>").attr({
					rel: "stylesheet",
					type: "text/css",
					href: "https://cdn.jsdelivr.net/gh/imysoss/imoss5/imsf/Public/jquery.flickity/2.1.1/flickity.min.css"
				}).appendTo("head");
				$.getScript("https://cdn.jsdelivr.net/gh/imysoss/imoss5/imsf/Public/jquery.flickity/2.1.1/flickity.pkgd.min.js", function(){
	...
	'image': {//图片
		'lazyload': function(){//延迟加载
			...
			$.getScript("https://cdn.jsdelivr.net/gh/imysoss/imoss5/imsf/Public/jquery.lazyload/1.9.7/jquery.lazyload.min.js", function(response, status) {
				$("img.ff-img").lazyload({
					placeholder : "https://cdn.jsdelivr.net/gh/imysoss/imoss5/imsf/Public/images/no.jpg",
					effect : "fadeIn",
					failurelimit: 15
					//threshold : 400
	...
	'search': {//搜索
		...
		'autocomplete': function(){//3.5增加搜索结果控制 4.1update
			...
			if( $limit > 0){
				...
				$.getScript("https://cdn.jsdelivr.net/gh/imysoss/imoss5/imsf/Public/jquery.devbridge-autocomplete/1.4.7/jquery.autocomplete.min.js", function(response, status) {
					$('.ff-wd').autocomplete({
